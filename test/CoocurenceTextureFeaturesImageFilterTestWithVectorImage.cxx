...
int CoocurenceTextureFeaturesImageFilterTestWithVectorImage( int argc, char *argv[] )
{
  if( argc < 4 )
    {
  ...
  EXERCISE_BASIC_OBJECT_METHODS( filter, CoocurenceTextureFeaturesImageFilter,
    ImageToImageFilter );
