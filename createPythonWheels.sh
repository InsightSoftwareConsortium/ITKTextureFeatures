...
curl -L https://github.com/InsightSoftwareConsortium/ITKPythonBuilds/releases/download/latest/ITKPythonBuilds-linux.tar.zstd -O ITKPythonBuilds-linux.tar.zstd
./zstd-1.2.0-linux/bin/unzstd ITKPythonBuilds-linux.tar.zstd -o ITKPythonBuilds-linux.tar
